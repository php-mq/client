...
namespace PHPMQ\Client\Tests\Unit\Streams;

use PHPMQ\Client\Streams\Stream;
use PHPMQ\Client\Tests\Unit\Fixtures\Traits\SocketMocking;
use PHPMQ\Client\Tests\Unit\Fixtures\Traits\StreamIdentifierMocking;
...
final class StreamTest extends TestCase
{
	...
	/**
	 * @expectedException \PHPMQ\Client\Streams\Exceptions\ReadTimedOutException
	 */
	...
	/**
	 * @expectedException \PHPMQ\Client\Streams\Exceptions\WriteTimedOutException
	 */
